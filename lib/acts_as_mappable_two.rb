...
module ActsAsMappableTwo
  ...
  module ClassMethods # :nodoc:
    ...
    def acts_as_mappable_two(options = {})
      metaclass = (class << self; self; end)

      # Mix in the module, but ensure to do so just once.
      return if !defined?(Geokit::Mappable) || metaclass.included_modules.include?(ActsAsMappableTwo::SingletonMethods)

      send :extend, Geokit::ActsAsMappableTwo::SingletonMethods
