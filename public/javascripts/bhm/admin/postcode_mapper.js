BHM.withNS('Admin.PostcodeMapper', function(ns) {
  ...
  postcodes = [];
  map = null;
  ns.Postcode = function Postcode(postcode, lat, lng, count) {
  ...
  ns.addPostcode = function addPostcode(postcode, lat, lng, count) {
    return postcodes.push(new ns.Postcode(postcode, lat, lng, count));
  };
  ns.autoAddPostcodes = function autoAddPostcodes() {
  ...
  ns.addMarkers = function addMarkers() {
    var _a, _b, _c, _d, _e, _f, _g, cluster, currentMap, i, markers, postcode;
