...
describe User do
  ...
  describe 'when getting a users age' do
    ...
    it 'should let you pass a custom from time' do
      User.make(:date_of_birth => (21.years + 6.months).ago).age(7.months.ago).should == 20
      User.make(:date_of_birth => 18.years.ago).age(1.year.ago).should   == 17
      User.make(:date_of_birth => 18.years.ago).age((1.year + 3.days).ago).should   == 16
      User.make(:date_of_birth => 18.years.ago).age((1.year - 3.days).ago).should   == 17
    end
